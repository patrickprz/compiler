...
_lr_productions = [
  ...
  ('p_program_p -> program','p_program_p',1,'p_program_p','program.py',92),
  ('p_program_p -> program p_program_p','p_program_p',2,'p_program_p','program.py',93),
  ('program -> expression','program',1,'p_program','program.py',98),
  ('program -> expression_ctrl','program',1,'p_program','program.py',99),
  ('program -> var_assign','program',1,'p_program','program.py',100),
  ('program -> VAR var_type var_declaration SEMICOLON','program',4,'p_program','program.py',101),
  ('var_declaration -> var_type_id','var_declaration',1,'p_var_declaration','program.py',107),
  ('var_declaration -> var_declaration SEMICOLON var_type var_type_id','var_declaration',4,'p_var_declaration','program.py',108),
  ('var_type_id -> id_class','var_type_id',1,'p_var_type_id','program.py',114),
  ('var_type_id -> var_type_id COMMA id_class','var_type_id',3,'p_var_type_id','program.py',115),
  ('var_type -> REAL','var_type',1,'p_var_type','program.py',120),
  ('var_type -> INTVAR','var_type',1,'p_var_type','program.py',121),
  ('id_class -> ID','id_class',1,'p_id_class','program.py',126),
  ('id_class -> ID LEFT_BRACKET INT RIGHT_BRACKET','id_class',4,'p_id_class','program.py',127),
  ('id_class -> ID LEFT_BRACKET ID RIGHT_BRACKET','id_class',4,'p_id_class','program.py',128),
  ('var_assign -> id_class EQUALS expression SEMICOLON','var_assign',4,'p_var_assign','program.py',133),
  ('expression -> id_class','expression',1,'p_expression_var','program.py',138),
  ('expression -> expression MULTIPLY expression','expression',3,'p_expression','program.py',144),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','program.py',145),
  ('expression -> expression PLUS expression','expression',3,'p_expression','program.py',146),
  ('expression -> expression MINUS expression','expression',3,'p_expression','program.py',147),
  ('expression -> expression POWER expression','expression',3,'p_expression','program.py',148),
  ('expression -> INT','expression',1,'p_expression_int_float','program.py',154),
  ('expression -> FLOAT','expression',1,'p_expression_int_float','program.py',155),
  ('expression -> LEFT_PAR expression RIGHT_PAR','expression',3,'p_expression_par','program.py',160),
  ('expression_co -> var_assign','expression_co',1,'p_expression_co','program.py',165),
  ('expression_co -> expression_ctrl','expression_co',1,'p_expression_co','program.py',166),
  ('expression_c -> expression_co','expression_c',1,'p_expression_c','program.py',171),
  ('expression_c -> expression_co expression_c','expression_c',2,'p_expression_c','program.py',172),
  ('expression_bra -> LEFT_BRACES expression_c RIGHT_BRACES','expression_bra',3,'p_expression_bra','program.py',177),
  ('expression_rl -> expression RL_OP expression','expression_rl',3,'p_expression_rl','program.py',182),
  ('expression_ctrl -> WHILE LEFT_PAR expression_rl RIGHT_PAR expression_bra','expression_ctrl',5,'p_cmd_rl','program.py',187),
  ('expression_ctrl -> IF LEFT_PAR expression_rl RIGHT_PAR expression_bra','expression_ctrl',5,'p_cmd_rl','program.py',188),
  ('expression_ctrl -> IF LEFT_PAR expression_rl RIGHT_PAR expression_bra ELSE expression_bra','expression_ctrl',7,'p_cmd_rl','program.py',189),
]
